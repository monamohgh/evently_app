...
abstract class AppLocalizations {
  ...
  /// No description provided for @this_is_a_birthday_party.
  ///
  /// In en, this message translates to:
  /// **'This is a Birthday Party '**
  String get this_is_a_birthday_party;
  ...
  /// No description provided for @discover_unique_exhibitions_and_talents.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @first_onboarding.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @second_onboarding.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @third_onboarding.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @fourth_onboarding.
  ///
  /// In en, this message translates to:
